...
SECRET_KEY = 'django-insecure-wdck5m)b$p$#2)$59vc@f1!9tfnnp9#ffm52c@mrodikjgnwu^'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=30),  # Access token valid 30 minutes
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),     # Refresh token valid 1 day
    'ROTATE_REFRESH_TOKENS': True,                   # Generate new refresh token each time it's used
